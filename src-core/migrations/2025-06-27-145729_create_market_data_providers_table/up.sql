...
VALUES
    ...
    ('VN_FUND', 'VN Fund Service', 'Market data provider for Vietnamese mutual funds. Provides historical and real-time data for Vietnamese investment funds.', 'http://127.0.0.1:8765/docs', 4, FALSE, 'vn-fund.png', NULL, NULL, NULL);