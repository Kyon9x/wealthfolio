...
VALUES
    ...
    ('VN_MARKET', 'Viet Nam Market Service', 'Market data provider for Vietnamese mutual funds, stocks, bonds and more. Provides historical and real-time data for Vietnamese investment funds, stocks, bonds and more.', NULL, 4, FALSE, 'vn-market.png', NULL, NULL, NULL);