...
//!
//! Provides the wealthvn-ai crate with access to server services
//! for tool execution and settings management.

use std::sync::{Arc, RwLock};

use wealthvn_ai::{AiEnvironment, ChatRepositoryTrait, SecretStore};
use wealthvn_core::{
    accounts::AccountServiceTrait, activities::ActivityServiceTrait,
    goals::GoalServiceTrait, holdings::HoldingsServiceTrait,
    performance::PerformanceServiceTrait, settings::SettingsServiceTrait,
